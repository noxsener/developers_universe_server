...
import com.codenfast.developersuniverse.offlinedbinfo.controller.OfflineDbInfoController;
...
@RequestMapping(path = "api/offline-db-info", consumes = MediaType.TEXT_PLAIN_VALUE, produces = MediaType.TEXT_PLAIN_VALUE)
@RestController
@lombok.RequiredArgsConstructor
@Slf4j
public class OfflineDbInfoApiController {

    private final OfflineDbInfoController offlineDbInfoController;
    ...
    public String save(@RequestHeader(StringConstant.AHEADER) String data, @RequestBody String encryptData) throws JsonProcessingException, CodenfastSecurityException {
        return encryptService.writeValue(data, offlineDbInfoController.save(encryptService.readValue(data, encryptData, OfflineDbInfoDto.class)));
    }
    ...
    public String update(@RequestHeader(StringConstant.AHEADER) String data, @RequestBody String encryptData) throws JsonProcessingException, CodenfastSecurityException {
        return encryptService.writeValue(data, offlineDbInfoController.update(encryptService.readValue(data, encryptData, OfflineDbInfoDto.class)));
    }
