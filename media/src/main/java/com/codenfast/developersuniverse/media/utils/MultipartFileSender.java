package com.codenfast.developersuniverse.media.utils;
...
public class MultipartFileSender {
    ...
    private static final int DEFAULT_BUFFER_SIZE = 40960; // ..bytes = 20KB.
    ...
    public void serveResource() throws Exception {
        ...
        String contentType = new org.apache.tika.Tika().detect(filepath);
        if(StringUtils.isBlank(contentType) && filepath.endsWith(".webp")) {
    ...
    private static class Range {
        ...
        @SuppressWarnings({"java:S2674", "squid:S2674"})
