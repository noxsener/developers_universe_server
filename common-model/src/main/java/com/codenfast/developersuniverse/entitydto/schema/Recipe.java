...
public class Recipe implements EntityModel {
    private String id;
     ...
     */
    private CreativeWork recipeInstructions;

    /**
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     */
    private QuantitativeValue recipeYield;
     ...
     */
    private java.util.List<CreativeWork> steps;

    /**
     * A sub-property of instrument. A supply consumed when performing instructions or a direction.
     */
    private HowToSupply supply;
     ...
     */
    private QuantitativeValue yield;
