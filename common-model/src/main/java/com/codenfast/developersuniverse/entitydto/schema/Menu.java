...
public class Menu implements EntityModel {
    private String id;
    ...
    private Restaurant menuRestaurantParent;
    private Winery menuWineryParent;
    private Bakery menuBakeryParent;
    private BarOrPub menuBarOrPubParent;
    private Brewery menuBreweryParent;
    private CafeOrCoffeeShop menuCafeOrCoffeeShopParent;
    private Distillery menuDistilleryParent;
    private FastFoodRestaurant menuFastFoodRestaurantParent;
    private FoodEstablishment menuFoodEstablishmentParent;
    private IceCreamShop menuIceCreamShopParent;
}